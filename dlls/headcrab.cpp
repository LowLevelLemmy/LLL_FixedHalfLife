...
//=========================================================
int CHeadCrab::ISoundMask(void)
{
	return bits_SOUND_MEAT;
}
...
Schedule_t* CHeadCrab :: GetScheduleOfType ( int Type )
{
	...
	{
		ALERT(at_console, "The Crab Smells Food \n");
		return &slCrabEat[0];	//Will eat if not attackin
	}
	...
	switch	( Type )
	{
		...
		{
			return &slHCRangeAttack1[ 0 ];	//disabled cuz I want the crab to eat ALWAYS
		}
		break;
	}
